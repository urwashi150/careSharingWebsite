...
$message .= "https://studenturwashi.host20.uk/activate.php?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'urwahshi015patidar@gmail.com')){
