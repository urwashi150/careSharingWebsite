...
//$sql = "SELECT * FROM carsharetrips WHERE departure='bhopal' && destination='maheshwar'" ;

$queryChoices = [$queryChoice2, $queryChoice1];
*/
$departure = "bhopal";
$destination ="maheshwar";
$sql = "SELECT * FROM carsharetrips WHERE departure='".$departure."' && destination='". $destination."'" ;
